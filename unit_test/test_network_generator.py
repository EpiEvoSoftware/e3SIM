...
from network_generator_oo import BaseNetworkGenerator, ERGenerator, RPGenerator, BAGenerator, UserInputGenerator
...
class TestBaseNetworkGenerator:
    ...
    def test_init_with_none_seed(self):
        ...
        with patch('numpy.random.seed') as mock_seed:
            generator = BaseNetworkGenerator(100, rand_seed=None)
