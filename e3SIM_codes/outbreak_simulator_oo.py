...
from post_simulation_func_2025 import *
...
class GenomeElement:
    ...
    link: Any
    alpha_trans: int | float
    alpha_drug: int | float
...
class SlimScriptGenerator:
    ...
    def __init__(self, config: SimulationConfig):
        ...
        self.code_path = Path(__file__).parent / "slim_scripts_2025"
...
class SimulationOrchestrator:
    ...
    def run(self):
        ...
        try:
            ...
            print("SLiM script:", script_path, flush = True)
    ...
    def _generate_parameter_file(self):
        ...
        with open(param_file, 'w') as f:
            ...
            f.write(f"alpha_trans:{self.config.genome_config.alpha_trans}\n")
            f.write(f"alpha_drug:{self.config.genome_config.alpha_drug}\n")
